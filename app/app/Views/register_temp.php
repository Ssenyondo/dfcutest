            ...
            <div class="auth-box">
                <div>
                    <div class="logo">
                        ...
                        <h5 class="font-medium m-b-20">Edit employee details</h5>
                    </div>
                    <!-- Form -->
                    <div class="row">
                        <div class="col-12">
                            ...
                            <form class="form-horizontal m-t-20" method="post" enctype="multipart/form-data" action="<?=site_url('addstaff')?>" novalidate>
                                <div class="form-group row ">
                                    <div class="col-12 ">
                                        <h5>Employee surname <span class="text-danger">*</span></h5>
                                        <input name="emp_surname" class="form-control form-control-lg" type="text" required data-validation-required-message="This field is required" aria-invalid="true">
                                        <?php if($validation->getError('emp_surname')) {?>
                                            <label style="color:#f0643b"><?= $error = $validation->getError('emp_surname')?></label>
                                        <?php }?>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-12 ">
                                        <h5>Employee other name <span class="text-danger">*</span></h5>
                                        <input name="emp_othername" class="form-control form-control-lg" type="text" required data-validation-required-message="This field is required" aria-invalid="true">
                                        <?php if($validation->getError('emp_othername')) {?>
                                            <label style="color:#f0643b"><?= $error = $validation->getError('emp_othername')?></label>
                                        <?php }?>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group m-b-0 m-t-10 ">
                                    <div class="col-sm-12 text-center ">
                                        dfcu HR Portal <?php echo anchor('login', '<b>Sign In</b>', 'class="text-info m-l-5"') ?> | <?php echo anchor('edit', '<b>Edit</b>', 'class="text-info m-l-5"') ?>
                                    </div>
                                </div>
                            </form>
                        </div>
